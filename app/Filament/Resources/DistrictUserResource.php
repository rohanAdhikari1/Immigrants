...
use App\Filament\Resources\DistrictUserResource\Pages;
use App\Filament\Resources\DistrictUserResource\RelationManagers;
...
class DistrictUserResource extends Resource
{
    protected static ?string $model = DistrictUser::class;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('district_id')
                    ...
                    ->searchable()
                    ->options(function () {
                        return District::whereDoesntHave('users', function ($q) {
            ...
            ->columns([
                ...
                Tables\Columns\IconColumn::make('is_active')
                    ...
                    ->action(function ($record) {
                        ...
                        $record->save();
                        Notification::make()
                            ->title($record->is_active ? 'District User Activated' : 'District User Deavtivated')
                            ->success()
                            ->send();
                    }),
    ...
    {
        return [
            'index' => Pages\ListDistrictUsers::route('/'),
            'create' => Pages\CreateDistrictUser::route('/create'),
            'view' => Pages\ViewDistrictUser::route('/{record}'),
            'edit' => Pages\EditDistrictUser::route('/{record}/edit'),
        ];
    }
}
