...
class ReportsCopyController extends Controller
{
    public function save(Request $request)
    {
        $validated = $request->validate([
            ...
            'family_memeber_count' => 'numeric|nullable',
            'family_members_male_count' => 'numeric|nullable',
            'family_members_female_count' => 'numeric|nullable',
            'family_members_other_count' => 'numeric|nullable',
            'family_migration_count' => 'numeric|nullable',
            'family_members_migration_male_count' => 'numeric|nullable',
            'family_members_migration_female_count' => 'numeric|nullable',
            'family_members_migration_other_count' => 'numeric|nullable',
            'ward_no' => 'required|numeric',
            'address_1' => 'nullable',
            'address_2' => 'nullable',
            'house_no' => 'nullable',
            'total_family_returned' => 'numeric|nullable',
            'total_family_returned_male' => 'numeric|nullable',
            'total_family_returned_female' => 'numeric|nullable',
            'total_family_returned_other' => 'numeric|nullable',
            'name' => 'required',
            'gender' => 'required',
            'age' => 'numeric',
            'contact_no' => 'nullable',
            ...
            'have_done_skill_test' => 'boolean|nullable',
            'want_to_skill_test' => 'boolean|nullable',
            'foreign_income_used_for' => 'nullable',
            'saved_foreign_income' => 'nullable',
            'plan_to_business' => 'nullable',
            'business_plan' => 'nullable',
            'doing_business' => 'nullable',
            'current_business' => 'nullable',
            'employees_on_current_business' => 'nullable|numeric',
            ...
            'remittance_before_covid' => 'nullable',
            'previous_year_remittance_count' => 'nullable',
            'previous_year_remittance_amount' => 'nullable',
